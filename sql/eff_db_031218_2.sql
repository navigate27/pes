...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2018 at 11:10 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_add_manpower_count_id` (IN `p_prcs_detail_id` INT, IN `p_actual` INT, IN `p_absent` INT, IN `p_support` INT, IN `p_batch_id` INT, IN `p_group_id` INT)  NO SQL
BEGIN
...
(process_detail_id, actual, absent, support, batch_id, not_count, group_id) VALUES
(p_prcs_detail_id, p_actual, p_absent, p_support, p_batch_id, _is_count, p_group_id);
...
INSERT INTO `eff_1_manpower_count` (`ID`, `process_detail_id`, `actual`, `absent`, `support`, `not_count`, `group_id`, `batch_id`) VALUES
(1, 1, 0, 0, 0, 0, 1, 56),
(2, 2, 0, 0, 0, 0, 1, 56),
(3, 3, 0, 0, 0, 0, 1, 56),
(4, 4, 0, 0, 0, 0, 1, 56),
