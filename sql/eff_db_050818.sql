...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2018 at 05:24 AM
...
--
ALTER TABLE `eff_product_rep`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2575;

--
-- AUTO_INCREMENT for table `eff_product_st`
--
ALTER TABLE `eff_product_st`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6142;
